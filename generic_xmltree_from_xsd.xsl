    ...
    <xsl:template match="/">
      <xsl:element name="xsl:stylesheet">
        ...
        <xsl:element name="xsl:template">
          ...
          <img src="../images/seqicon_uparrow.png" height="15px" align="right" alt="⇑"/>
          <img src="../images/seqicon_downarrow.png" height="15px" align="right" alt="⇓"/>
          <img src="../images/seqicon_plus.png" height="15px" align="right" alt="+"/>
          <img src="../images/seqicon_x.png" height="15px" align="right" alt="X"/>
          <img src="../images/seqicon_code.png" height="15px" align="right" alt="&lt;..&gt;"/>
        </xsl:element>
        ...
        <xsl:element name="xsl:template">
          ...
          <xsl:text>divtree</xsl:text><xsl:element name="xsl:for-each"><xsl:attribute name="select"><xsl:text>ancestor-or-self::*</xsl:text></xsl:attribute><xsl:text>__</xsl:text><xsl:element name="xsl:value-of"><xsl:attribute name="select"><xsl:text>name()</xsl:text></xsl:attribute></xsl:element><xsl:text>_</xsl:text><xsl:element name="xsl:value-of"><xsl:attribute name="select"><xsl:text>count(preceding-sibling::*[name(.) = name(current())])+1</xsl:text></xsl:attribute></xsl:element></xsl:element>
        </xsl:element>
        ...
        <xsl:element name="xsl:template">
          ...
          <img height="15px">
            ...
            <xsl:element name="xsl:attribute"><xsl:attribute name="name"><xsl:text>xtsm_viewer_event</xsl:text></xsl:attribute><xsl:text>onclick:toggleProp_update_editor('expanded');</xsl:text></xsl:element>
          </img>
          <input type="checkbox">
          ...
          <img height="15px">
            <xsl:element name="xsl:attribute"><xsl:attribute name="name"><xsl:text>xtsm_viewer_event</xsl:text></xsl:attribute><xsl:text>onclick:toggleProp_update_editor('lock');</xsl:text></xsl:element>
            <xsl:element name="xsl:attribute">
              <xsl:attribute name="name">
                <xsl:text>src</xsl:text>
              </xsl:attribute>
        ...
        <xsl:element name="xsl:template">
          ...
          <input>
            ...
            <xsl:element name="xsl:attribute">
              ...
              <xsl:text>onchange:updateElement_update_editor('')</xsl:text>
            </xsl:element>
          </input>
          <xsl:element name="xsl:if">
            <xsl:attribute name="test">
